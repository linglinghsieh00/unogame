...
# Project:  project.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile project.pro QT+=widgets 'QT+=core gui' 'QT+=widgets multimedia'
#############################################################################
...
DISTDIR = /home/user/project2-5/.tmp/project1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: project.pro /usr/lib/qt5/mkspecs/cygwin-g++/qmake.conf /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt5/mkspecs/features/lex.prf \
		project.pro
	$(QMAKE) -o Makefile project.pro QT+=widgets 'QT+=core gui' 'QT+=widgets multimedia'
...
distdir: FORCE
	...
	$(COPY_FILE) --parents card.h config.h gamecontroller.h gamer.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents card.cpp gamecontroller.cpp gamer.cpp main.cpp mainwindow.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: config.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt5/mkspecs/cygwin-g++ -I/home/user/project2-5 -I/home/user/project2-5 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtMultimedia -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/lib/gcc/x86_64-pc-cygwin/10/include/c++ -I/usr/lib/gcc/x86_64-pc-cygwin/10/include/c++/x86_64-pc-cygwin -I/usr/lib/gcc/x86_64-pc-cygwin/10/include/c++/backward -I/usr/lib/gcc/x86_64-pc-cygwin/10/include -I/usr/include -I/usr/include/w32api mainwindow.h -o moc_mainwindow.cpp
